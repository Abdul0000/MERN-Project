...
export const signup = createAsyncThunk('/signup',async({name,email,password,question,navigate},{rejectedWithValue})=>{
    try {
...
export const login = createAsyncThunk('/login',async({email,password,navigate},{rejectedWithValue})=>{
    try {
